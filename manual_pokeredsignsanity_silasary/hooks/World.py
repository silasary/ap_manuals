...
def before_generate_early(world: World, multiworld: MultiWorld, player: int) -> None:
    ...
    """
    slot_name = get_option_value(multiworld, player, "slot")
    for i, name in multiworld.player_name.items():
        if name == slot_name:
            world.attached_slot = i
            break
    else:
        raise OptionError(f"Could not find a player with the name {slot_name} to attach to.")
    pass
